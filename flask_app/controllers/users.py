...
# def handle_my_custom_event(json, data, methods=['GET', 'POST'], messageReceived=None):
#
#     results = connectToMySQL('pulse_db').query_db(
#         f"INSERT INTO messages (content, sender_id, receiver_id) VALUES (data['message'], data['user_id'], "
#         f"data['person_id']);")
#
...
#
#     # Assuming you have a 'connectToMySQL' function for database connection
#     # Make sure to properly handle your database connection and queries
#     # This example demonstrates the database query part only
...
#     try:
#         results = connectToMySQL('pulse_db').query_db(query)
#     except Exception as e:
#         # Handle the database error, log, or send an error response
#         print(f"Database error: {str(e)}")
#         return
#
#     print('Received my event: ' + str(data))
#
#     # Emit a 'my response' event back to the client
...
def handle_my_custom_event(json, methods=['GET', 'POST'],
    ...
    query = (f"INSERT INTO messages (content, sender_id, receiver_id) VALUES ('{message}',"
             f" {user_id}, {person_id});")
    connectToMySQL('pulse_db').query_db(query)
